...
import { GET_PASSENGERS, DELETE_PASSENGER, ADD_PASSENGER, UPDATE_PASSENGER } from '../GraphQL/Passengers/queries';
        ...
        <div>
            {
                loading ?
                    ...
                    <div>
                        ...
                        <ListPassenger updatePengunjung={handleUpdateButton} hapusPengunjung={hapusPengunjung} />
                    </div>
            }
        </div>
    );
